...
export const BENCHMARK_CAPABILITIES:BenchmarkCapability[]=[
  ...
  ,entry("Google","merchant_ai_performance","Merchant Center AI performance insights","covered","authorised scoped export import","Organic AI performance evidence retains merchant account, category, country, language and time-window scope; it remains labelled as an authorised export rather than a live API connection.",34,"https://support.google.com/merchants/answer/17200695")
  ,entry("Google","conversational_attributes","Merchant Center conversational attributes","covered","verified-fact product readiness and preview","Question/answer, document link, related product, item-group title and variant-option gaps are audited from connected catalogue facts. The preview never writes to Merchant Center.",34,"https://support.google.com/merchants/answer/17085370")
  ,entry("Shopify","meta_agentic_channel","Meta agentic storefront channel readiness","covered","authorised Shopify channel-state observation","Discovery and direct-checkout state are kept separate, unsupported features remain visible and direct-checkout attribution requires Shopify channel/server evidence rather than unavailable browser pixels.",34,"https://help.shopify.com/en/manual/online-sales-channels/agentic-storefronts/meta")
  ,entry("WebMCP","action_mapper","Business-specific AI action mapping","covered","Fix My Site action planner","Only actions backed by Business Brain facts and a real system or safe handoff are proposed; unavailable capabilities stay explicit.",35,"https://developer.chrome.com/docs/ai/webmcp/imperative-api")
  ,entry("WebMCP","installer","WebMCP site installer/bridge","covered","reversible WordPress/WooCommerce + generic adapter","The first-party plugin exposes read-only WooCommerce tools, uses same-origin bridges, starts disabled and supports rollback without storing payment credentials.",35,"https://developer.chrome.com/docs/ai/webmcp/imperative-api")
  ,entry("WebMCP","runtime_monitoring","Real browser WebMCP journey verification","covered","authorised browser-runtime evidence adapter","Registered tools, schema, source-of-truth matches, latency and drift fingerprints are retained; ordinary monitoring refuses consequential actions.",35,"https://developer.chrome.com/docs/ai/webmcp/secure-tools")
  ,entry("PayPal","webmcp_reuse","PayPal Store Sync/WebMCP reuse path","covered","provider-aware implementation router","The router prefers PayPal only when observed access, physical-goods, US-customer and USD constraints all fit; otherwise it selects another adapter or safe handoff.",35,"https://webmcp-store.paypal.com/")
];
