...
export interface PageSignals {
  ...
  // Integration presence/capability signals only. IDs and keys are deliberately not extracted.
  algoliaDetected:boolean;
  algoliaRecommendSignals:boolean;
  algoliaAnalyticsSignals:boolean;
  algoliaAdminKeyRisk:boolean;
}
